...
//
const BotName = 'SI GEMBUL✨'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ozan_gans16'; // Nama Instagramlu cok
const whatsapplu = '0831-2280-8260'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/FYHHMoDeeUE0oq6faBF0jk'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/FYHHMoDeeUE0oq6faBF0jk'; // OFCICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan kode code Qrnya zan!!`);
});
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ozan_gans16`)
})
